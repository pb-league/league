...
(async function init() {
  ...
  function renderTournamentBracket() {
    ...
    // Detect tournament: later rounds have fewer games than round 1 (elimination)
    // Detect tournament: any pairing with type 'tourn-game' means this is a tournament session
    ...
    const lastRoundGames = weekPairings.filter(g => g.round === lastRound && (g.type === 'game' || g.type === 'tourn-game'));
